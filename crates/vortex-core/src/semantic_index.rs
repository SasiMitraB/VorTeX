use crate::bibtex_parser::{parse_bib_file, BibEntryItem};
use crate::latex_parser::{
...
/// Bump when the serialized shape of indexed items changes; older caches are rebuilt.
const INDEX_VERSION: usize = 2;
