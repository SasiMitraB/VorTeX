// Monaco with its editor features but none of its ~80 bundled languages or
// language services (generated from monaco-editor/editor/editor.main.js).
// LaTeX support is ours: see latex.ts.
